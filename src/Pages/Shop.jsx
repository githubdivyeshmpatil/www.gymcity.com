...
<div className="w-full bg-red-500 text-white font-bold py-2">
...
<div className="container mx-auto px-4 py-8 text-justify">
    ...
    <p className="text-gray-500 mb-6 rajdhani-font ">
    ...
    <h2 className="text-xl font-semibold mb-2">Products we offer</h2>
    <p className="text-gray-500 mb-6 rajdhani-font ">
    ...
    <h2 className="text-xl font-semibold mb-2">Authenticity Guarantee</h2>
    <p className="text-gray-500 rajdhani-font ">
